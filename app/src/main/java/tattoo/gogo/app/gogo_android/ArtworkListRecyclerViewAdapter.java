 ...
 * specified {@link ArtistArtworkListFragment.OnArtistArtworkListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ArtworkListRecyclerViewAdapter extends RecyclerView.Adapter<ArtworkListRecyclerViewAdapter.ViewHolder> {

    private final List<ArtWork> mValues;
    private final ArtistArtworkListFragment.OnArtistArtworkListFragmentInteractionListener mListener;
    private final Fragment mFragment;
    private final String mArtistName;

    public ArtworkListRecyclerViewAdapter(Fragment fr, List<ArtWork> items,
                                          ArtistArtworkListFragment.OnArtistArtworkListFragmentInteractionListener listener,
                                          String artistName) {
        mValues = items;
        mListener = listener;
        mFragment = fr;
