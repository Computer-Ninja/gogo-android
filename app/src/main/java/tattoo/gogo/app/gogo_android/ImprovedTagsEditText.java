 ...
 * BETA
 */
public class ImprovedTagsEditText extends AutoCompleteTextView {
    ...
    public ImprovedTagsEditText(Context context) {
        super(context);
        init(null, 0, 0);
    }

    public ImprovedTagsEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }

    public ImprovedTagsEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ImprovedTagsEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
